...
constexpr ptrdiff_t dwEntityList = 0x4D4F25C;
constexpr ptrdiff_t dwForceAttack = 0x31807A8;
constexpr ptrdiff_t dwForceAttack2 = 0x31807B4;
constexpr ptrdiff_t dwForceBackward = 0x31807FC;
constexpr ptrdiff_t dwForceForward = 0x3180808;
constexpr ptrdiff_t dwForceJump = 0x51F8EF4;
constexpr ptrdiff_t dwForceLeft = 0x3180820;
constexpr ptrdiff_t dwForceRight = 0x3180814;
constexpr ptrdiff_t dwGameDir = 0x629678;
constexpr ptrdiff_t dwGameRulesProxy = 0x526C1EC;
constexpr ptrdiff_t dwGetAllClasses = 0xD6103C;
constexpr ptrdiff_t dwGlobalVars = 0x58AAD8;
constexpr ptrdiff_t dwGlowObjectManager = 0x5297080;
constexpr ptrdiff_t dwInput = 0x51A0808;
constexpr ptrdiff_t dwInterfaceLinkList = 0x904AF4;
constexpr ptrdiff_t dwLocalPlayer = 0xD3ABEC;
constexpr ptrdiff_t dwMouseEnable = 0xD40790;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD40760;
constexpr ptrdiff_t dwPlayerResource = 0x317EB40;
constexpr ptrdiff_t dwRadarBase = 0x5183FCC;
constexpr ptrdiff_t dwSensitivity = 0xD519EC;
constexpr ptrdiff_t dwSensitivityPtr = 0xD519C0;
constexpr ptrdiff_t dwSetClanTag = 0x89FB0;
constexpr ptrdiff_t dwViewMatrix = 0x4D40BA4;
constexpr ptrdiff_t dwWeaponTable = 0x51A12C8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xE0E00002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD45638;
...
constexpr ptrdiff_t m_yawClassPtr = 0xD403F0;
constexpr ptrdiff_t m_pitchClassPtr = 0x5184268;
...
constexpr ptrdiff_t set_abs_angles = 0x1D52D0;
constexpr ptrdiff_t set_abs_origin = 0x1D5110;
constexpr ptrdiff_t is_c4_owner = 0x3ADAD0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3A1032;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x1F4B2460;
